...
#include "MyFirstGameProjectile.h"
...
void AMyFirstGameCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Bind fire event
	PlayerInputComponent->BindAction("PrimaryAction", IE_Pressed, this, &AMyFirstGameCharacter::OnPrimaryAction);

	// Enable touchscreen input
	EnableTouchscreenMovement(PlayerInputComponent);

	// Bind movement events
	PlayerInputComponent->BindAxis("Move Forward / Backward", this, &AMyFirstGameCharacter::MoveForward);
	PlayerInputComponent->BindAxis("Move Right / Left", this, &AMyFirstGameCharacter::MoveRight);
	...
	PlayerInputComponent->BindAxis("Turn Right / Left Gamepad", this, &AMyFirstGameCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("Look Up / Down Gamepad", this, &AMyFirstGameCharacter::LookUpAtRate);
}

void AMyFirstGameCharacter::OnPrimaryAction()
{
